...
install_XrayR() {
    ...
    file="https://github.com/newxrayr/XrayR-script/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/newxrayr/XrayR-script/master/XrayR.sh
